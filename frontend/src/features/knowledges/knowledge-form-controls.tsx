        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem className={fillParent ? 'flex min-h-0 flex-1 flex-col' : undefined}>
                    {showLabel ? <FormLabel>{uiT('Content')}</FormLabel> : null}
                    <FormControl>
                        <MarkdownEditor
                            ...
                            placeholder={uiT('Knowledge content (will be embedded into the vector store)')}
                            value={field.value}
                        />
                    </FormControl>
                    <FormMessage />
        ...
        <div className="flex flex-col gap-4">
            <div className="grid gap-4 sm:grid-cols-2">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>{uiT('Document type')}</FormLabel>
                            <Select
                                disabled={isSaving}
                                onValueChange={(value) =>
                            ...
                            >
                                <FormControl>
                                    <SelectTrigger>
                                        <SelectValue placeholder={uiT('Select type')} />
                                    </SelectTrigger>
                                </FormControl>
                                <SelectContent>
                ...
                {docType === KnowledgeDocType.Guide ? (
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>{uiT('Guide type')}</FormLabel>
                                <Select
                                    disabled={isSaving}
                                ...
                                >
                                    <FormControl>
                                        <SelectTrigger>
                                            <SelectValue placeholder={uiT('Select guide type')} />
                                        </SelectTrigger>
                                    </FormControl>
                                    <SelectContent>
                ...
                {docType === KnowledgeDocType.Answer ? (
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>{uiT('Answer type')}</FormLabel>
                                <Select
                                    disabled={isSaving}
                                    onValueChange={field.onChange}
                                    value={field.value}
                                >
                                    <FormControl>
                                        <SelectTrigger>
                                            <SelectValue placeholder={uiT('Select answer type')} />
                                        </SelectTrigger>
                                    </FormControl>
                                    <SelectContent>
                ...
                {docType === KnowledgeDocType.Code ? (
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>{uiT('Code language')}</FormLabel>
                                {/*
                                ...
                                >
                                    ...
                                    <AutocompleteContent>
                                        <AutocompleteEmpty>{uiT('No matching language')}</AutocompleteEmpty>
                                        <AutocompleteGroup>
                                            {LANGUAGES.map((lang) => (
                                                <AutocompleteItem
                                                    key={lang}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel>{uiT('Question')}</FormLabel>
                        <FormControl>
                            <InputGroup className="block">
                                <InputGroupTextareaAutosize
                                    ...
                                    maxRows={6}
                                    minRows={1}
                                    placeholder={uiT('Short title or question this document answers')}
                                />
                            </InputGroup>
                        </FormControl>
                        <FormMessage />
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        <FormLabel>{uiT('Description (optional)')}</FormLabel>
                        <FormControl>
                            <InputGroup className="block">
                                <InputGroupTextareaAutosize
                                    {...field}
                                    ...
                                    maxRows={8}
                                    minRows={1}
                                    placeholder={uiT('Optional short description')}
                                />
                            </InputGroup>
                        </FormControl>
                        <FormMessage />
