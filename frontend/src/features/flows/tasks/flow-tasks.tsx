                                ...
                                <FormControl>
                                    <InputGroup>
                                        ...
                                        <InputGroupInput
                                            {...field}
                                            autoComplete="off"
                                            placeholder={uiT('Search tasks and subtasks...')}
                                            type="text"
                                        />
                                        {field.value && (
            ...
            {hasTasks ? (
                ...
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{uiT('No tasks found for this flow')}</EmptyTitle>
                        <EmptyDescription>
                            {uiT('Tasks will appear here once the agent starts working')}
                        </EmptyDescription>
                    </EmptyHeader>
                </Empty>
            )}
