            ...
            <div className="max-w-full">
                <ScrollArea className="w-full pb-3">
                    <TabsList className="flex w-fit">
                        <TabsTrigger value="automation">{uiT('Automation')}</TabsTrigger>
                        <TabsTrigger value="assistant">{uiT('Assistant')}</TabsTrigger>
                        <TabsTrigger value="dashboard">{uiT('Dashboard')}</TabsTrigger>
                    </TabsList>
