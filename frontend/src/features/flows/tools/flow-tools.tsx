                                ...
                                <FormControl>
                                    <InputGroup className="flex-1">
                                        ...
                                        <InputGroupInput
                                            {...field}
                                            autoComplete="off"
                                            placeholder={uiT('Search tool logs...')}
                                            type="text"
                                        />
                                        {field.value && (
            ...
            {hasLogs ? (
                ...
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{uiT('No search logs found')}</EmptyTitle>
                ...
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{uiT('No search logs available')}</EmptyTitle>
                        <EmptyDescription>
                            {uiT('Search logs will appear here when the agent performs searches')}
                        </EmptyDescription>
                    </EmptyHeader>
                </Empty>
            )}
