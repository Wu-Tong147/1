    ...
    const placeholder = useMemo(() => {
        ...
        switch (flowStatus) {
            case StatusType.Created: {
                return uiT('The flow is starting...');
            }

            case StatusType.Failed:
            case StatusType.Finished: {
                return uiT('This flow has ended. Create a new one to continue.');
            }

            case StatusType.Running: {
                return uiT('PentAGI is working... Click Stop to interrupt');
            }

            case StatusType.Waiting: {
                return uiT('Provide additional context or instructions...');
            }
            ...
            {filteredLogs.length > 0 ? (
                ...
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{uiT('No active tasks')}</EmptyTitle>
                        <EmptyDescription>
                            {uiT(
