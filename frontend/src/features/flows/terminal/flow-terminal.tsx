                                ...
                                <FormControl>
                                    <InputGroup className="flex-1">
                                        ...
                                        <InputGroupInput
                                            {...field}
                                            autoComplete="off"
                                            placeholder={uiT('Search terminal logs...')}
                                            type="text"
                                        />
            ...
            {hasActiveFilters && !hasLogs && (
                <Empty>
                    <EmptyHeader>
                        ...
                        <EmptyTitle>{uiT('No terminal logs found')}</EmptyTitle>
